...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/kagsv_mgr: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/kagsv_mgr ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/unix.o: unix.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/unix.o unix.cpp
...
${OBJECTDIR}/mgr.o: mgr.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/mgr.o mgr.cpp

${OBJECTDIR}/telnet.o: telnet.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/telnet.o telnet.cpp
